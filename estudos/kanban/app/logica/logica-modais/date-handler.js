...
const datesHandler = {
   ...
   /************************************************************************************************************/
   editingPeriod: '',
   handleStartDate: function (date, endDate, removeStartDate, setPeriod) {
      let newDate;
      ...
      setPeriod({ ...this.editingPeriod, inicio: newDate, fim: fim });
   },

   handleEndDate: function (date, startDate, removeEndDate, setPeriod) {
      let newDate;
      ...
      if (!removeEndDate) {
         ...
         if (this.isStartDateGreaterThanEndDate(startDate, newDate)) {
            setPeriod({ ...this.editingPeriod, inicio: '', fim: newDate });
            return;
         }
      }
      //Atualiza o valor de periodoEmEdicao
      this.editingPeriod = { ...this.editingPeriod, inicio: startDate, fim: newDate };
      setPeriod(this.editingPeriod); //Seta o novo periodo no estado periodo em Modal-data.js 28;
   }
}
export { datesHandler }